...
# 126 "mcc_generated_files/examples/../pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 138 "mcc_generated_files/examples/../pin_manager.h"
...
# 1 "mcc_generated_files/examples/../uart1.h" 1
# 74 "mcc_generated_files/examples/../uart1.h"
typedef union {
    struct {
        unsigned perr : 1;
        unsigned ferr : 1;
...
# 110 "mcc_generated_files/examples/../uart1.h"
void UART1_Initialize(void);
# 158 "mcc_generated_files/examples/../uart1.h"
_Bool UART1_is_rx_ready(void);
# 206 "mcc_generated_files/examples/../uart1.h"
_Bool UART1_is_tx_ready(void);
# 253 "mcc_generated_files/examples/../uart1.h"
_Bool UART1_is_tx_done(void);
# 301 "mcc_generated_files/examples/../uart1.h"
uart1_status_t UART1_get_last_status(void);
# 350 "mcc_generated_files/examples/../uart1.h"
uint8_t UART1_Read(void);
# 375 "mcc_generated_files/examples/../uart1.h"
void UART1_Write(uint8_t txData);
# 395 "mcc_generated_files/examples/../uart1.h"
void UART1_SetFramingErrorHandler(void (* interruptHandler)(void));
# 413 "mcc_generated_files/examples/../uart1.h"
void UART1_SetOverrunErrorHandler(void (* interruptHandler)(void));
# 431 "mcc_generated_files/examples/../uart1.h"
...
# 98 "mcc_generated_files/examples/../mcc.h"
...
void I2CSIMPLE_example(void)
{
    ...
    uint8_t i=0;
    uint8_t sendData[17] = {0x00,0x00,0xA1,0xA2,0xA3,0xA4,0xA5,0x27,0xA7,0xA8,0xA9,0xAA,0xAB,0xAC,0xAD,0xAE,0xAF};
    uint8_t receiveData[15];
 i2c_writeNBytes(0xA0,receiveData,1);
    i2c_writeNBytes(0xA0,sendData,sizeof(sendData));
 ...
 _delay((unsigned long)((100)*(8000000/4000.0)));
    ...
    i2c_writeNBytes(0xA0,receiveData,2);


    i2c_readNBytes(0xA0,receiveData,sizeof(receiveData));
