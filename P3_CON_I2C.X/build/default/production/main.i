...
# 1 "./mcc_generated_files/examples/i2c_simple_example.h" 1
# 33 "./mcc_generated_files/examples/i2c_simple_example.h"
...
# 43 "main.c"
    while (1){
        ...
        if(est.instruccion[0]==1){
           ...
           i2c_writeNBytes(0x50,datosEnvio,2);
           i2c_readNBytes(0x50,datosRecibidos,1);
           ...
           est.instruccion[0]=0;
            ...
            i2c_writeNBytes(0x50,datosEnvio,2);
            i2c_readNBytes(0x50,datosRecibidos,est.rs_num[0]);
            ...
            i2c_writeNBytes(0x50,datosEnvio,3);
            i2c_writeNBytes(0x50,datosEnvio,2);
            i2c_readNBytes(0x50,datosRecibidos,1);
            est.instruccion[2]=0;
        }
        else if(est.instruccion[3]==1){
            UART1_Write('W');
            UART1_Write('s');
            datosEnvio[0]=(est.add[0]-48)*16;
            datosEnvio[0]=(est.add[1]-48)+datosEnvio[0];
            ...
            i2c_writeNBytes(0x50,datosEnvio,sizeof(datosEnvio));
            est.instruccion[3]=0;
